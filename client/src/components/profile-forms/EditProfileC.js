...
import { createProfileC, getCurrentProfile } from "../../actions/profile";
const EditProfileC = ({
  ...
  const onSubmit = e => {
    e.preventDefault();
    createProfileC(formData, history, true);
  };
  return (
    <Fragment>
...
export default connect(
  mapStateToProps,
  { createProfileC, getCurrentProfile }
)(withRouter(EditProfileC));
